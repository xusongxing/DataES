...
import cn.xsx.web.dao.conf.DatabaseConfig;
 ...
 * 所以WebApplicationInitializer就是整个项目的关键，整个项目就是通过它来启动。
 */
public class WebApplicationInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    protected Class<?>[] getRootConfigClasses() {
        return new Class[]{DspConfig.class, DatabaseConfig.class, SecurityConfig.class};
    }
